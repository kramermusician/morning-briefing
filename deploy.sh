...
set -e
cd "$(dirname "$0")"
# Rebuild the word cloud from the curated feedNews (mechanical, local-only).
python3 "$HOME/Desktop/Kramer-Projects-2026/scripts/utilities/briefing_wordcloud.py" || echo "wordcloud: skipped (keeping last)"
